  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${SERVER_URL}/api/uniware/sale-orders/unhold`,
        payload
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Resume processing of a sale order that was
          previously placed on hold in Uniware.
        </p>
      </div>
...
export default UnholdSaleOrder;