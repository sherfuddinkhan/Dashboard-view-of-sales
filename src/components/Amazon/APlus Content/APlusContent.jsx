...
const APlusContent = () => {
  ...
  const loadContent = async () => {
    ...
    try {
      const res = await axios.post(`${NODE_API}/amazon/aplus/content`, {
        accessToken,
  ...
  return (
    <div style={styles.container}>
      <h2>A+ Content Management API - v2020-11-01</h2>
      <p style={styles.sub}>Search, Create & Publish A+ Content Documents</p>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.row}>
          ...
          <div style={{ flex: 1 }}>
            <label style={styles.label}>ASIN (Optional - Filter)</label>
            <input
              value={asin}
        ...
        <button onClick={loadContent} disabled={loading} style={styles.btn}>
          {loading ? "Searching..." : "Search A+ Content Documents"}
        </button>
      </div>
