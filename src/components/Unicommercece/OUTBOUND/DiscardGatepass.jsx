  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${SERVER_URL}/api/uniware/gatepasses/discard`,
        {
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          >
            Discard or void an existing Uniware
            gatepass.
          </p>
        </div>
        ...
        >
          ...
          Discarding a gatepass is an operational
          action. Verify the gatepass code and
          facility before submitting.
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "22px" }}>
            ...
            <small style={helpStyle}>
              Enter the existing gatepass code you
              want to discard.
            </small>
          </div>
        ...
        {result && (
          ...
          >
            ...
            >
              {result.successful
                ? "Gatepass Discarded Successfully"
                : "Gatepass Discard Failed"}
            </h3>
...
export default DiscardGatepass;