  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${SERVER_URL}/api/uniware/sale-orders/unhold-items`,
        {
      ...
      setResult(
        apiError || {
          ...
          message:
            err.message ||
            "Failed to unhold sale order items.",
          errors: [],
          warnings: [],
        }
      );
        ...
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>
              Unhold one or more sale order items that
              were previously placed on hold.
            </p>
          </div>
            ...
            <div style={styles.sectionHeader}>
              <div>
                ...
                <p style={styles.helperText}>
                  Enter the item codes that should be
                  released from hold.
                </p>
              </div>
...
export default UnholdSaleOrderItems;